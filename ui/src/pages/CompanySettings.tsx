...
export function CompanySettings() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      { label: selectedCompany?.name ?? t('companySettings.company'), href: "/dashboard" },
              ...
              >
                <div className="space-y-2">
                  ...
                  {logoUploadMutation.isPending && (
                    <span className="text-xs text-muted-foreground">{	("companySettings.uploadingLogo")}</span>
                  )}
                </div>
              </Field>
              <Field
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              {inviteMutation.isPending
                ? t("common.generating")
                : t("companySettings.generateInvite")}
            </Button>
          </div>
          {inviteError && (
            ...
            <div className="rounded-md border border-border bg-muted/30 p-2">
              ...
              <div className="mt-1 space-y-1.5">
                ...
                <div className="flex justify-end">
                  ...
                  >
                    {snippetCopied ? t("common.copied") : t("companySettings.copySnippet")}
                  </Button>
                </div>
              </div>
            </div>
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-md border border-border px-4 py-4">
          <p className="text-sm text-muted-foreground">
            ...
            <a href="/org" className="underline hover:text-foreground">{	("nav.orgChart")}</a> header.
          </p>
